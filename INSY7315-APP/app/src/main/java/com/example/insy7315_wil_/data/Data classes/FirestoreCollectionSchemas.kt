...
object FirestoreCollectionSchemas {
    val all = listOf(
        ...
        FirestoreCollectionSchema(FirestoreCollections.AUDIO_CONTENT, "{audioId}", listOf("title", "description", "category", "storagePath", "durationSeconds", "active")),
        ...
        FirestoreCollectionSchema(FirestoreCollections.QUIZ_QUESTIONS, "{questionId}", listOf("quizId", "questionText", "options")),
        FirestoreCollectionSchema(FirestoreCollections.QUIZ_RESULTS, "{resultId}", listOf("userId", "quizId", "recommendedCategoryId", "scores", "createdAt")),
